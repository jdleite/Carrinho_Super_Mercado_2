package br.com.carrinho_super_mercado.ui.coin;
...
public class MoedaEditText extends AppCompatEditText {
    private static String prefix = "";
    private static final int MAX_LENGTH = 20;
    private static final int MAX_DECIMAL = 3;
    private CurrencyTextWatcher currencyTextWatcher = new CurrencyTextWatcher(this, prefix);

    public MoedaEditText(Context context) {
        this(context, null);
    }

    public MoedaEditText(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.editTextStyle);
    }

    public MoedaEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static class CurrencyTextWatcher implements TextWatcher {
        ...
        public CurrencyTextWatcher(EditText editText, String prefix) {
